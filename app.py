...
def analyze_question_type(question: str) -> dict:
    ...
    # Configure response parameters based on type
    response_configs = {
        "short": {
            "max_tokens": 200,
            "temperature": 0.1,
...
def get_adaptive_system_prompt(response_type: str) -> str:
    ...
    base_prompt = """You are an AI assistant that provides accurate answers based on the given context."""
    
    type_specific_prompts = {
        "short": """
Instructions:
- Provide informative answers with good detail and context
- Use multiple paragraphs to explain thoroughly
- Include relevant background information and examples
- Aim for comprehensive coverage while staying focused
- Explain concepts clearly with supporting details
""",
        "medium": """
Instructions:
- Provide extensive, well-structured answers with comprehensive detail
- Use multiple paragraphs with thorough explanations
- Include detailed examples, context, and background information
- Cover all relevant aspects with proper organization
- Be comprehensive and educational in your response
""",
        "detailed": """
Instructions:
- Provide exhaustive, thorough explanations with extensive detail
- Use multiple paragraphs with comprehensive structure
- Include numerous examples, detailed context, and complete background
- Explain concepts thoroughly from multiple angles
- Cover all relevant aspects comprehensively
- Use bullet points, numbered lists, and subheadings where helpful
...
if __name__ == "__main__":
    ...
    with col1:
        ...
        if temp_count > 0 and st.button("🗑️ Clear Temp Docs"):
